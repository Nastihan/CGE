...
namespace CGE
{
	namespace RHI
	{
        ImageViewDescriptor::ImageViewDescriptor(Format overrideFormat) : m_overrideFormat{ overrideFormat } {}

        ImageViewDescriptor ImageViewDescriptor::Create(Format format, uint16_t mipSliceMin, uint16_t mipSliceMax)
        {
        ...
        ImageViewDescriptor ImageViewDescriptor::Create(Format format, uint16_t mipSliceMin, uint16_t mipSliceMax, uint16_t arraySliceMin, uint16_t arraySliceMax)
        {
            ImageViewDescriptor descriptor;
            descriptor.m_overrideFormat = format;
            descriptor.m_mipSliceMin = mipSliceMin;
        ...
        ImageViewDescriptor ImageViewDescriptor::CreateCubemap(Format format, uint16_t mipSliceMin, uint16_t mipSliceMax)
        {
        ...
        ImageViewDescriptor ImageViewDescriptor::CreateCubemap(Format format, uint16_t mipSliceMin, uint16_t mipSliceMax, uint16_t cubeSliceMin, uint16_t cubeSliceMax)
        {
        ...
        ImageViewDescriptor ImageViewDescriptor::CreateCubemapFace(Format format, uint16_t mipSliceMin, uint16_t mipSliceMax, uint16_t faceSlice)
        {
            ImageViewDescriptor descriptor;
            descriptor.m_overrideFormat = format;
            descriptor.m_mipSliceMin = mipSliceMin;
        ...
        ImageViewDescriptor ImageViewDescriptor::Create3D(Format overrideFormat, uint16_t mipSliceMin, uint16_t mipSliceMax, uint16_t depthSliceMin, uint16_t depthSliceMax)
        {
            ImageViewDescriptor descriptor;
