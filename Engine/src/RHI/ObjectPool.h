...
namespace CGE
{
    namespace RHI
    {
        ...
        public:
            ...
            {
                // inform the compiler that it's intentionally not used. suppress warning.
                (void)object;
            }
        ...
        public:
            ...
            ObjectType* Allocate(Args&&... args)
            {
...

                {
                    ...
                    {
                        Ptr<ObjectType> objectPtr = m_factory.CreateObject(std::forward<Args>(args)...);
                        if (objectPtr)
                        {
                ...
                if (objectForReset)
                {
                    m_factory.ResetObject(*objectForReset, std::forward<Args>(args)...);
                }
        ...
        private:
            ...
            std::unordered_set<RHI::Ptr<ObjectType>> m_objects;
