...
namespace CGE
{
	namespace RHI
	{
        ...
        VirtualAddress FreeListAllocator::Allocate(size_t byteCount, size_t byteAlignment)
        {
            ...
            byteAlignment = std::max<size_t>(byteAlignment, m_descriptor.m_alignmentInBytes);
            ...
            assert(m_byteCountTotal <= m_descriptor.m_capacityInBytes);
        ...
        void FreeListAllocator::GarbageCollectInternal(const Garbage& garbage)
        {
            ...
            assert(m_byteCountTotal >= byteCountAligned);
            m_byteCountTotal -= byteCountAligned;
        ...
        void FreeListAllocator::FreeInternal(size_t address, const Allocation& allocation)
        {
            ...
            if (handleNext.IsValid())
            {
                ...
                assert(nodePrevious.m_addressOffset < nodeNext.m_addressOffset);
        ...
        size_t FreeListAllocator::GetRequiredSize(size_t requestedSize, size_t requestedAlignment, size_t addressOffset)
        {
